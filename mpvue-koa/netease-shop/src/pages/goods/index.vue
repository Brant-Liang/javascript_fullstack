<template>
  <div class="goods">
    ...
    <div class="section_nav" @click="showType">
      <div>请选择规格数量</div>
      <div></div>
    </div>
    <!-- 商品参数 -->
...
export default {
  ...
  onShareAppMessage() {
    return {
      ...
      path: '/pages/goods/main?id' + this.id,
  ...
  methods: {
    ...
    async goodsDetail() {
      ...
      this.goods_desc =  this.goods_desc.replace(/\<img/gi, '<img style="display: none"')
