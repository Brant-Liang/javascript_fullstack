<template>
  <div class="sidebar" :class="{showbar: showSidebar}">
    <div class="sidebar-con" :class="{showbar: showSidebar}">
      <div class="head">
        <div class="avatar">
          <img src="http://img0.imgtn.bdimg.com/it/u=3874840072,2236197744&fm=15&gp=0.jpg" alt="">
        </div>
        <div class="name">曾经也是个王者</div>
      </div>
      <div class="menu">
        <ul>
          <li>
    ...
    <div class="sidebar_mask" v-show="showSidebar" @click="_hidebar">
    </div>
  </div>
</template>
